...
for(i=1:1:length(dirData))
    ...
    %
    %   C:\Users\shawn\Box\Snowflake X Phase III\SnowflakeX Phase III\CampRoberts_07_17\Data\Day4-Thursday\roberts_thu_payload2_u0_Jul_20_08_48-1.csv
    %
    % To extend the code to different selected data or a different text file,
    % generate a function instead of a script.

    % Auto-generated by MATLAB on 2017/07/20 12:24:07

    %% Initialize variables.
    %filename = 'C:\Users\shawn\Box\Snowflake X Phase III\SnowflakeX Phase III\CampRoberts_07_17\Data\Day4-Thursday\roberts_thu_payload2_u0_Jul_20_08_48-1.csv';
    delimiter = ',';
    ...
    microseconds_since_start = cell2mat(raw(:, 1));
    msl_gps = cell2mat(raw(:, 2));
    ...
    save_step = strcat(save_filename,'-alt');

    plot(microseconds_since_start,msl_gps);
    fig = gcf;
